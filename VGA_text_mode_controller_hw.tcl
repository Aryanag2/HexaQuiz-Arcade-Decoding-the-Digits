...
# Tue May 02 20:47:53 CDT 2023
# DO NOT MODIFY


# 
# VGA_text_mode_controller "VGA Text Mode Controller" v1.0
# Zuofu Cheng 2023.05.02.20:47:53
# 
# 
...
# 
add_interface time conduit end
set_interface_property time associatedClock CLK
set_interface_property time associatedReset RESET
set_interface_property time ENABLED true
set_interface_property time EXPORT_OF ""
set_interface_property time PORT_NAME_MAP ""
set_interface_property time CMSIS_SVD_VARIABLES ""
set_interface_property time SVD_ADDRESS_GROUP ""

add_interface_port time mins mins Input 6
add_interface_port time secs secs Input 6


# 
# connection point states
# 
add_interface states conduit end
set_interface_property states associatedClock CLK
set_interface_property states associatedReset ""
set_interface_property states ENABLED true
set_interface_property states EXPORT_OF ""
set_interface_property states PORT_NAME_MAP ""
set_interface_property states CMSIS_SVD_VARIABLES ""
set_interface_property states SVD_ADDRESS_GROUP ""

add_interface_port states fsm fsm Input 3
